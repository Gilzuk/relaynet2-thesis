...
\tightlist
\item
  \textbf{169 parameters:} This model is sufficient to attain the reported BER, but its bias and variance were not estimated separately.
\item
  \textbf{3,000 parameters:} Performance is nearly identical to 169 parameters; the measurements do not establish higher predictive variance.
\item
