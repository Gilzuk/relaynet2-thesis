...
Here \(P_{\text{current}}\) is estimated over the complete simulated relay-output block. The normalization is therefore block-adaptive and noncausal at the symbol level; it is appropriate to the block-buffered simulation but should not be interpreted as an online gain known before observing the block.
