...
Generative models offer an alternative to directly learning a denoising function (the discriminative approach above): they instead learn the distribution of clean signals \(p(\mathbf{x})\) and reconstruct the transmitted signal from noisy observations via Bayes' rule:
