...
system model whose scope Chapter~\ref{sec:methods} states in full: memoryless,
white noise, uncoded, per-symbol. Their objective is accordingly to compare
relay functions under matched-model conditions; channel memory and estimation
are deliberate departures introduced only in Chapter~\ref{sec:unknown-channels}.
...
\begin{figure}[htbp]
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/coded_reliable_regime.png}}
